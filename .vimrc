...
" patch for a visual bug causing artifacts at startup
set t_u7=

"""""""""""""""""""""""""""""""""""""""""""""
"
"   Prevent nested vim, handle terminal input
"
"""""""""""""""""""""""""""""""""""""""""""""
...
set nocp 	" run in nocompatibility for WSL
set number	
set relativenumber
set ts=2
set sw=2
...
set noshowmode
set shortmess+=F
" set term=xterm-256color-italics " depricated. defined in tmux 
...
"""""""""""""""""""""""""""""""""""""""""""""
"
"   Load Vim-Plugs + Settings for Plugs
"
"""""""""""""""""""""""""""""""""""""""""""""
...
Plug 'catppuccin/vim', { 'as': 'catppuccin_macchiato' }
Plug 'dag/vim-fish'
...
Plug 'OmniSharp/omnisharp-vim' " c# autocompletion, requires :OmniSharpInstall
Plug 'tpope/vim-fugitive'      " git
call plug#end()

" enable COC + omnisharp
...
let NERDTreeSplexMode=1  " for use with splex branch only

"start with nerdtree open, but to left of the main window
...
" reminder to self - normal mode plus mapleader (,)
let mapleader = ","
...
if has("patch-8.1.1564")
  ...
  set signcolumn=number " yes, no, number
else
  set signcolumn=yes
endif
